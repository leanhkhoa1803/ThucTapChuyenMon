                                                ...
                                                <div class="product_desc">
                                                    ...
                                                    <div class="add-actions">
                                                        <ul class="add-actions-link">
                                                            ...
                                                            <li><a href="{{  asset('detailProduct/'.$item->prod_id.'/'.$item->prod_slug.'.html') }}" 
                                                                title="quick view" class="quick-view-btn"><i class="fa fa-eye"></i></a></li>
                    ...
                    <div class="sidebar-categores-box mt-sm-30 mt-xs-30">
                        ...
                        <div class="category-sub-menu">
                            <ul>
                                ...
                                <li class=""><a href="{{ asset('category/'.$item->cate_id.'/'.$item->cate_slug.'.html') }}">{{ $item->cate_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
